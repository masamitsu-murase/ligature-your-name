...
def decorate(font, glyph, deco_type):
    ...
    if deco_type in (DECORATE_BOTTOMLINE, DECORATE_BOTHLINE):
        ...
        pen.lineTo(0, -descent + (ascent + descent) * line_ratio)
        pen.lineTo(width, -descent + (ascent + descent) * line_ratio)
        pen.lineTo(width, -descent)
        pen.closePath()
    if deco_type in (DECORATE_TOPLINE, DECORATE_BOTHLINE):
        ...
        pen.moveTo(0, ascent)
        pen.lineTo(width, ascent)
        pen.lineTo(width, ascent - (ascent + descent) * line_ratio)
        pen.lineTo(0, ascent - (ascent + descent) * line_ratio)
        pen.closePath()
